...
function init() {
    ...
    audioLoader.load('assets/audio/can_opening.mp3', function (buffer) {
    ...
    loader.load(modelPath, function (gltf) {
        ...
        if(modelPath === 'assets/models/soda_can_crush.glb') {
            secondMixer = mixer;
...
loadModel('assets/models/soda_can_opening.glb');
const switchBtn = document.getElementById("switchModel");
switchBtn.addEventListener('click', function () {
   loadModel('assets/models/soda_can_crush.glb')
});
